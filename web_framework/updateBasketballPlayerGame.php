...
$UpdateQuery = "UPDATE basketballPlayerGame SET `playername`='$_POST[Playername]', `date`='$_POST[Date]', `minutes`='$_POST[Minutes]', `points`='$_POST[Points]', `rebounds`='$_POST[Rebounds]', 
...
$DeleteQuery = "DELETE FROM basketballPlayerGame WHERE `id`='$_POST[hidden]'";
...
if(isset($_POST['add'])) {
$AddQuery = "INSERT INTO basketballPlayerGame (playername, date, points, rebounds, assists, steals, blocks, turnovers, fga, fgm, 3pa, 3pm, fta, ftm, userkey, minutes) VALUES 
	     ('$_POST[uplayername]', '$_POST[udate]', '$_POST[upoints]', '$_POST[urebounds]', '$_POST[uassists]', 
	     '$_POST[usteals]', '$_POST[ublocks]', '$_POST[uturnovers]', '$_POST[ufga]', '$_POST[ufgm]', '$_POST[u3pa]', '$_POST[u3pm]', '$_POST[ufta]', '$_POST[uftm]', '$id', '$_POST[uminutes]')";
...
$sql = "SELECT * from basketballPlayerGame WHERE userkey = '$id'";
...
echo "<form action=updateBasketballPlayerGame.php method=post>";
echo "<tr>";
echo "<td>" . "<input type=text name=Playername value=" . $record['playername'] . " </td>";
echo "<td>" . "<input type=text name=Date value=" . $record['date'] . " </td>";
echo "<td>" . "<input type=text name=Minutes value=" . $record['minutes'] . " </td>";
...
echo "<td><input type=text name=uminutes></td>";
