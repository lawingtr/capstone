...
<p>This is where you can view/edit the databases that you've already created.  Use one of the buttons below 
   to select which sport you're working with.</p>

<br>

<div class = "btn-d">
    <a href="accountBasketball.php">Basketball</a>
    <a href="accountBaseball.php">Baseball</a>
</div>
